                ...
                <div class="card">
                    <form action="save.php?action=edit" id="my-form" method="post" enctype="multipart/form-data">
                        <div class="product-imgs">
                            ...
                            <div class="img-select">
                                <div class="img-item" style="width: 25%; height: 25%;">
                                    <?php if ($row['AddPic1'] != "") { ?>
                                        <div class="img" id="img1"><img src="<?php echo $img1 ?>" alt="<?php echo $row["ProductName"] ?>"></div>
                                        <div class="file" id="choose">
                                            <label for="image1">Chọn ảnh</label>
                                            <input type="file" name="image1" id="image1" accept="image/png, image/jpeg, image/jpg">
                                            <i class="fa fa-times" onclick="delImage(1)" id="x1" style="display: none;"></i>
                                            <div id="preview1"></div>
                                        </div>
                                    <?php } elseif ($row['AddPic3'] == "") { ?>
                                        <div class="img" id="img1">
                                            <img src="../images/blank.jpg" alt="<?php echo $row["ProductName"] ?>" style="color: #707070">
                                ...
                                <div class="img-item" style="width: 25%; height: 25%;">
                                    <?php if ($row['AddPic2'] != "") { ?>
                                        <div class="img" id="img2"><img src="<?php echo $img2 ?>" alt="<?php echo $row["ProductName"] ?>"></div>
                                        <div class="file" id="choose">
                                            <label for="image2">Chọn ảnh</label>
                                            <input type="file" name="image2" id="image2" accept="image/png, image/jpeg, image/jpg">
                                ...
                                <div class="img-item" style="width: 25%; height: 25%;">
                                    <?php if ($row['AddPic3'] != "") { ?>
                                        <div class="img" id="img3"><img src="<?php echo $img3 ?>" alt="<?php echo $row["ProductName"] ?>"></div>
                                        <div class="file" id="choose">
                                            <label for="image3">Chọn ảnh</label>
                                            <input type="file" name="image3" id="image3" accept="image/png, image/jpeg, image/jpg">
                                ...
                                <div class="img-item" style="width: 25%; height: 25%;">
                                    <?php if ($row['AddPic4'] != "") { ?>
                                        <div class="img" id="img4"><img src="<?php echo $img4 ?>" alt="<?php echo $row["ProductName"] ?>"></div>
                                        <div class="file" id="choose">
                                            <label for="image4">Chọn ảnh</label>
                                            <input type="file" name="image4" id="image4" accept="image/png, image/jpeg, image/jpg">
                        ...
                        <div class="product-content">
                            ...
                            <?php }
                            if (str_contains($row['CategoryName'], ' ') && str_contains($row['Material'], ' ')) { ?>
                            ...
                            <div class="product-info">
                                <p class=""><span style="color:red; display:inline;">* </span>Tên:
                                    <input type="text" id="cname" name="cname" value="<?php echo $row["CategoryName"]; ?>" required>
                                </p>
                                <p class=""><span style="color:red; display:inline;">* </span>Mã phân loại: <input type="text" id="cateid" name="cateid" value="<?php echo $row["CategoryID"]; ?>" required></p>
                                <p class="">Chất liệu: <input type="text" id="material" name="material" value="<?php echo $row["Material"]; ?>"></p>
                        ...
                        <div class="btn">
                            ...
                            <div id="myModal" class="modal" style="font-size: 20px;">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="save.php?action=new" method="POST" role="form" enctype="multipart/form-data">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a style="text-decoration: none;">
                                            <button type="button" id="edit<?php echo $i ?>" class="fa fa-pencil-square-o" style="border: none; font-size: 25px; "></button>
                                        </a>
                                        <!-- The Modal -->
                                        <div id="myModal<?php echo $i ?>" class="modal">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <h2>Thông tin chi tiết </h2>
                                                <form action="save.php?action=edit-size&pid=<?php echo $row1["ProductID"]; ?>" method="POST" role="form" enctype="multipart/form-data">
                                                    <div class="modal-details">
                                                        <p class="">Mã sản phẩm <span style="color:red; display:inline;">*</span>
                                                        <div><input type="text" name="proid" value="<?php echo $row1["ProductID"]; ?>" required></div>
                                                        </p>
                                                        <p class="">Size
                                                        <div><input type="text" name="size" value="<?php echo $row1["Size"]; ?>">
                                                        </div>
                                                        </p>

                                                        <p class="">Giá <span style="color:red; display:inline;">*</span>
                                                        <div><input type="number" name="price" value="<?php echo $row1["Price"]; ?>" required>
                                                        </div>
                                                        </p>

                                                        <p class="">Số Lượng <span style="color:red; display:inline;">*</span>
                                                        <div><input type="number" name="quantity" value="<?php echo $row1["ProductQuantity"]; ?>" required></div>
                                                        </p>
                                                    </div>
                                                    <p style=" display: flex; justify-content: center; align-items: center;">
                                                        <button type="submit" class="button8">Lưu</button>
                                        ...
                                        <a href="edit_product.php?cid=<?php echo $row['CategoryID'] ?>&delete_size=<?php echo $row1['ProductID']; ?>">
                                            <button type="button" id="delete" class="fa fa-trash-o" style="border: none; font-size: 25px;" onclick='return checkdelete()'></button>
                                        </a>
                                    </td>
                                </tr>
                            <?php $i++;
